    ...
    e.fn.poptrox_disableSelection = function () {
        ...
        return l.on("resize orientationchange", function () {
            ...
            if ("ignore" != n && i.attr("href")) {
                ...
                "file:" == window.location.protocol && t.src.match(/^\/\//) && (t.src = "https:" + t.src), u.push(t), r.removeAttr("title"), i.removeAttr("href").css("cursor", "pointer").css("outline", 0).on("click", function (e) {
